export const endPoints = {
  ...
  CATEGORIES: {
    ...
    "POST /api/categories": {
      description:
        "accepts a body of slug and description, returns the body back",
      exampleRequestBody: {
        slug: "MMORPG",
  ...
  REVIEWS: {
    "GET /api/reviews": {
      description:
        "serves an object containing and array of all reviews, paginated automatically to a limit of 10, the total count of the reviews, and the number of pages.",
      queries: [
        "review_id",
        "comment_id",
        "sort_by",
    ...
    "PATCH /api/reviews/:review_id": {
      description:
        "accepts an object in the form {inc_votes : newVotes} where newVotes is an integer and returns the updated review.",
      queries: [],
      exampleRequest: "/api/reviews/1",
      exampleRequestBody: {
        inc_votes: 2,
  ...
  COMMENTS: {
    "GET /api/reviews/:review_id/comments": {
      description:
        "serves an object containing all comments associated with the given review ID automatically paginated to 10, and a total page count",
      queries: [
        "review_id",
        "comment_id",
        "sort_by",
    ...
    "POST /api/reviews/:review_id/comments": {
      description:
        "accepts an object with username and body properties, posts a comment and associates it with the given review_id, then responds with the posted comment",
